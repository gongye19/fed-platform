...
def _agent_prompt(job: dict[str, Any], instructions: str) -> str:
    ...
    return (
        ...
        'keys "new_state", "intents", and "evidence". "new_state" MUST be a JSON object, '
        '"intents" MUST be a JSON array, and "evidence" MUST be a JSON object; use {} when '
        'there is no state or evidence. Each intent has "kind" and "payload"; '
